...
namespace DotNetGraph.Edge
{
    public class DotEdge : DotElementWithAttributes
    {
        ...
        public DotRotationAttribute Rotation
        {
            get => GetAttribute<DotRotationAttribute>();
            set => SetAttribute(value);
        }

        public DotSocketAttribute Socket
        {
        ...
        {
            get => GetAttribute<DotSocketMirrorAttribute>();
            set => SetAttribute(value);
        }

        public DotMirrorAttribute Mirror
        {
            get => GetAttribute<DotMirrorAttribute>();
            set => SetAttribute(value);
        }
